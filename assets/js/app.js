document.addEventListener("DOMContentLoaded", function(event) {
  ...
  // Auto Enquiry Modal
  setTimeout(function(){ $('#enqModal').modal('show') }, 5000);
...
$('.enqModal').click(function() {        
  ...
  if(RedirectCookie){ 
    ...
    if(RedirectCookie == 'brochure'){ setCookie('redirectFileCookie', RedirectFileCookie); }
...
function gCaptchaRSF(){ $("#gCaptchaRSF").removeAttr('disabled'); }
function gCaptchaMOF(){ $("#gCaptchaMOF").removeAttr('disabled'); }
function gCaptchaPOF(){ $("#gCaptchaPOF").removeAttr('disabled'); }